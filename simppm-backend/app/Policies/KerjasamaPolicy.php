...
/**
 * Policy otorisasi untuk model Kerjasama (Kerja Sama).
 *
 * Fase Dampak (Kerja Sama): diisi/dikelola oleh mitra eksternal
...
class KerjasamaPolicy
{
    ...
    public function view(User $user, Kerjasama $kerjasama): bool
    {
        return $this->adalahPengelola($user)
            ...
            || $this->adalahPemilikMitra($user, $kerjasama);
    }
    ...
    {
        return $this->adalahPengelola($user) || $this->adalahPemilikMitra($user, $kerjasama);
    }
