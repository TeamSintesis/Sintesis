...
/**
 * Policy otorisasi untuk model IntegrasiKurikulum (Integrasi Kurikulum).
 *
 * Fase Proses (Integrasi Kurikulum): dikelola oleh dosen pengusul proposal
 ...
 */
class IntegrasiKurikulumPolicy
{
     ...
     * melihat detail data.
     */
    public function view(User $user, IntegrasiKurikulum $integrasiKurikulum): bool
    {
        return $this->adalahPengelola($user)
            || $this->adalahPemantau($user)
            || $this->adalahPemilikDosen($user, $integrasiKurikulum);
    }
     ...
     */
    public function update(User $user, IntegrasiKurikulum $integrasiKurikulum): bool
    {
        return $this->adalahPengelola($user) || $this->adalahPemilikDosen($user, $integrasiKurikulum);
    }

    /**
     * Dosen pengusul proposal terkait atau pengelola LPPM boleh menghapus.
     */
    public function delete(User $user, IntegrasiKurikulum $integrasiKurikulum): bool
    {
        return $this->adalahPengelola($user) || $this->adalahPemilikDosen($user, $integrasiKurikulum);
    }
