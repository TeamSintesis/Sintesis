...
/**
 * Policy otorisasi untuk model Kontrak (Kontrak Penugasan).
 *
 * Fase Proses (Kontrak Penugasan): sepenuhnya dikelola (create/update/delete)
...
class KontrakPolicy
{
    ...
    public function view(User $user, Kontrak $kontrak): bool
    {
        return $this->adalahPengelola($user)
            ...
            || $this->adalahPemilikDosen($user, $kontrak);
    }
