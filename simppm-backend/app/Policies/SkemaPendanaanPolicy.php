...
/**
 * Policy otorisasi untuk model SkemaPendanaan (Skema Pendanaan).
 *
...
class SkemaPendanaanPolicy
{
     ...
     */
    public function view(User $user, SkemaPendanaan $skemaPendanaan): bool
    {
        return true;
    }
     ...
     */
    public function update(User $user, SkemaPendanaan $skemaPendanaan): bool
    {
        return $this->adalahPengelola($user);
    }
     ...
     */
    public function delete(User $user, SkemaPendanaan $skemaPendanaan): bool
    {
        return $this->adalahPengelola($user);
    }
