...
// Skema JSON:API untuk entitas Monev (Monitoring dan Evaluasi).
...
/**
 * Skema JSON:API untuk resource "monev".
 *
 ...
 */
class MonevSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Monev::class;
