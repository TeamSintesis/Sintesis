...
// Skema JSON:API untuk entitas KlirensEtik (Klirens Etik).
...
/**
 * Skema JSON:API untuk resource "klirens-etik".
 *
 ...
 */
class KlirensEtikSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = KlirensEtik::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('nomorSertifikat', 'nomor_sertifikat'),
            Str::make('tanggalTerbit', 'tanggal_terbit')->sortable(),
