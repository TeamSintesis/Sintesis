...
// Skema JSON:API untuk entitas AnggotaTim (Anggota Tim Proposal).
...
/**
 * Skema JSON:API untuk resource "anggota-tim".
 *
 ...
 */
class AnggotaTimSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = AnggotaTim::class;
    ...
    public function fields(): array
    {
        return [
            ...
            BelongsTo::make('mahasiswa')->type('mahasiswa'),
            Str::make('peran', 'peran'),
    ...
    public function filters(): array
    {
        return [
            ...
            Where::make('mahasiswaId', 'mahasiswa_id'),
        ];
    }
