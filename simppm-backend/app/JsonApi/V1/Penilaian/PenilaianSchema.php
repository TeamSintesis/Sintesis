...
// Skema JSON:API untuk entitas Penilaian (Penilaian Proposal).
...
/**
 * Skema JSON:API untuk resource "penilaian".
 *
 ...
 */
class PenilaianSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Penilaian::class;
    ...
    public function fields(): array
    {
        return [
            ...
            BelongsTo::make('reviewer')->type('dosen'),
            Str::make('skor', 'skor'),
            Str::make('komentar', 'komentar'),
            Boolean::make('statusFinalisasi', 'status_finalisasi'),
    ...
    public function filters(): array
    {
        return [
            ...
            Where::make('reviewerId', 'dosen_id'),
            Where::make('statusFinalisasi', 'status_finalisasi'),
        ];
    }
