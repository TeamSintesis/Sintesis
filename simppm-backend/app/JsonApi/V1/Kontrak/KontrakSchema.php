...
// Skema JSON:API untuk entitas Kontrak (Kontrak Penugasan).
...
/**
 * Skema JSON:API untuk resource "kontrak".
 *
 ...
 */
class KontrakSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Kontrak::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('nomorSk', 'nomor_sk'),
            Str::make('tanggalKontrak', 'tanggal_kontrak')->sortable(),
            Str::make('nilaiKontrak', 'nilai_kontrak'),
            HasMany::make('pencairanDanaList')->type('pencairan-dana')->readOnly(),
