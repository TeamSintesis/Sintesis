...
// Skema JSON:API untuk entitas Mitra (Mitra Eksternal).
...
/**
 * Skema JSON:API untuk resource "mitra".
 *
 ...
 */
class MitraSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Mitra::class;
    ...
    public function fields(): array
    {
        return [
            ID::make(),
            Str::make('namaMitra', 'nama_mitra'),
            Str::make('jenisMitra', 'jenis_mitra'),
            Str::make('kontak', 'kontak'),
            Str::make('alamat', 'alamat'),
            HasMany::make('produkAdopsiList')->type('produk-adopsi')->readOnly(),
            HasMany::make('kerjasamaList')->type('kerjasama')->readOnly(),
    ...
    public function filters(): array
    {
        return [
            WhereIdIn::make($this),
            Where::make('jenisMitra', 'jenis_mitra'),
        ];
    }
