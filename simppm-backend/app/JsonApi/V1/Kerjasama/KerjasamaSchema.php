...
// Skema JSON:API untuk entitas Kerjasama (Kerja Sama).
...
/**
 * Skema JSON:API untuk resource "kerjasama".
 *
 ...
 */
class KerjasamaSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Kerjasama::class;
    ...
    public function fields(): array
    {
        return [
            ID::make(),
            BelongsTo::make('mitra')->type('mitra'),
            Str::make('ruangLingkup', 'ruang_lingkup'),
            Str::make('tanggalMulai', 'tanggal_mulai')->sortable(),
            Str::make('tanggalAkhir', 'tanggal_akhir')->sortable(),
