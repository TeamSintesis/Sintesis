...
// Skema JSON:API untuk entitas SaranaPrasarana (Sarana dan Prasarana).
...
/**
 * Skema JSON:API untuk resource "sarana-prasarana".
 *
 ...
 */
class SaranaPrasaranaSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = SaranaPrasarana::class;
    ...
    public function fields(): array
    {
        return [
            ID::make(),
            Str::make('namaSarpras', 'nama_sarpras'),
            Str::make('lokasi', 'lokasi'),
