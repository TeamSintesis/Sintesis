...
// Skema JSON:API untuk entitas IntegrasiKurikulum (Integrasi Kurikulum).
...
/**
 * Skema JSON:API untuk resource "integrasi-kurikulum".
 *
 ...
 */
class IntegrasiKurikulumSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = IntegrasiKurikulum::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('mataKuliah', 'mata_kuliah'),
            Str::make('rpsTautan', 'rps_tautan'),
