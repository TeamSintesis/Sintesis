...
// Skema JSON:API untuk entitas Renstra (Rencana Strategis).
...
/**
 * Skema JSON:API untuk resource "renstra".
 *
 ...
 */
class RenstraSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Renstra::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('periodeMulai', 'periode_mulai')->sortable(),
            Str::make('periodeAkhir', 'periode_akhir')->sortable(),
            Str::make('dokumenUrl', 'dokumen_url'),
            HasMany::make('petaJalanList')->type('peta-jalan')->readOnly(),
    ...
    public function filters(): array
    {
        return [
            ...
            Where::make('periodeMulai', 'periode_mulai'),
            Where::make('periodeAkhir', 'periode_akhir'),
        ];
    }
