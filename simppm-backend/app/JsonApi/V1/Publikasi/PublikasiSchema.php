...
// Skema JSON:API untuk entitas Publikasi (Publikasi).
...
/**
 * Skema JSON:API untuk resource "publikasi".
 *
 ...
 */
class PublikasiSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Publikasi::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('jurnalProsiding', 'jurnal_prosiding'),
            Str::make('indeksasi', 'indeksasi'),
            Str::make('tahun', 'tahun')->sortable(),
            Str::make('doi', 'doi'),
            Str::make('lisensi', 'lisensi'),
    ...
    public function filters(): array
    {
        return [
            ...
            Where::make('indeksasi', 'indeksasi'),
