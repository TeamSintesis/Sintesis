...
// Skema JSON:API untuk entitas ProdukAdopsi (Produk/Purwarupa Adopsi).
...
/**
 * Skema JSON:API untuk resource "produk-adopsi".
 *
 ...
 */
class ProdukAdopsiSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = ProdukAdopsi::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('namaProduk', 'nama_produk'),
            Str::make('buktiAdopsi', 'bukti_adopsi'),
