...
// Skema JSON:API untuk entitas SkemaPendanaan (Skema Pendanaan).
...
/**
 * Skema JSON:API untuk resource "skema-pendanaan".
 *
 ...
 */
class SkemaPendanaanSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = SkemaPendanaan::class;
    ...
    public function fields(): array
    {
        return [
            ID::make(),
            Str::make('namaSkema', 'nama_skema'),
            Str::make('jenis', 'jenis'),
            Str::make('plafonDana', 'plafon_dana'),
            Str::make('sumberDana', 'sumber_dana'),
