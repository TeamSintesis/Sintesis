...
// Skema JSON:API untuk entitas Rekognisi (Rekognisi).
...
/**
 * Skema JSON:API untuk resource "rekognisi".
 *
 ...
 */
class RekognisiSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Rekognisi::class;
