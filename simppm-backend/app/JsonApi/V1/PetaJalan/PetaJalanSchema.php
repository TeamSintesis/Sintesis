...
// Skema JSON:API untuk entitas PetaJalan (Peta Jalan Penelitian/PkM).
...
/**
 * Skema JSON:API untuk resource "peta-jalan".
 *
 ...
 */
class PetaJalanSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = PetaJalan::class;
    ...
    public function fields(): array
    {
        return [
            ID::make(),
            BelongsTo::make('renstra')->type('renstra'),
            BelongsTo::make('prodi')->type('prodi'),
            Str::make('bidangKeilmuan', 'bidang_keilmuan'),
    ...
    public function filters(): array
    {
        return [
            WhereIdIn::make($this),
            Where::make('renstraId', 'renstra_id'),
