...
// Skema JSON:API untuk entitas Spj (Surat Pertanggungjawaban).
...
/**
 * Skema JSON:API untuk resource "spj".
 *
 ...
 */
class SpjSchema extends Schema
{
    /**
     ...
     * @var string
     */
    public static string $model = Spj::class;
    ...
    public function fields(): array
    {
        return [
            ID::make(),
            BelongsTo::make('laporanAkhir')->type('laporan-akhir'),
            Str::make('jumlahRealisasi', 'jumlah_realisasi'),
    ...
    public function filters(): array
    {
        return [
            WhereIdIn::make($this),
            Where::make('laporanAkhirId', 'laporan_akhir_id'),
        ];
    }
