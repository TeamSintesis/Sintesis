...
// Skema JSON:API untuk entitas Prodi (Program Studi).
...
/**
 * Skema JSON:API untuk resource "prodi".
 *
...
class ProdiSchema extends Schema
{
     ...
     * @var string
     */
    public static string $model = Prodi::class;
    ...
    public function fields(): array
    {
        return [
            ID::make(),
            Str::make('namaProdi', 'nama_prodi'),
            Str::make('fakultas', 'fakultas'),
            HasMany::make('dosenList')->type('dosen')->readOnly(),
            HasMany::make('mahasiswaList')->type('mahasiswa')->readOnly(),
